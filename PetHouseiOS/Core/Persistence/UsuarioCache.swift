...
public final class UsuarioCache {
    ...
    public init(
        ...
        verificado: Bool, fotoUrl: String?, esAnfitrion: Bool, creadoEn: String?,
        mascotasJSON: Data, actualizadoEn: Date = .now
    ) {
        self.id = id
        self.nombre = nombre
        self.email = email
...
public extension UsuarioCache {
    ...
    convenience init(usuario: Usuario, mascotas: [Mascota]) {
        ...
        self.init(
            ...
            fotoUrl: usuario.fotoUrl, esAnfitrion: usuario.esAnfitrion,
    ...
    var comoUsuario: Usuario {
        Usuario(
            ...
            fotoUrl: fotoUrl, esAnfitrion: esAnfitrion, creadoEn: creadoEn
        )
    }
}
